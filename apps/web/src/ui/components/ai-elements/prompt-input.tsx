...
type DropdownItemClickArg = Parameters<
...
export const PromptInputActionAddScreenshot = ({
  ...
  const handleClick = useCallback(
    async (event: DropdownItemClickArg) => {
      onClick?.(event)
...
export const PromptInputTextarea = ({
  ...
  return (
    <InputGroupTextarea
      className={cn('field-sizing-content max-h-48 min-h-16 px-4', className)}
      name="message"
...
export const PromptInputHeader = ({ className, ...props }: PromptInputHeaderProps) => (
  <InputGroupAddon
    align="block-end"
    className={cn('order-first flex-wrap gap-1 px-4', className)}
    {...props}
  />
)
...
export const PromptInputFooter = ({ className, ...props }: PromptInputFooterProps) => (
  <InputGroupAddon
    align="block-end"
    className={cn('justify-between gap-1 px-4', className)}
    {...props}
  />
)
