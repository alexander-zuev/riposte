...
function FieldLabel({ className, ...props }: React.ComponentProps<typeof Label>) {
  return (
    <Label
      ...
      className={cn(
        'group/field-label peer/field-label flex w-fit gap-2 font-medium leading-snug group-data-[disabled=true]/field:opacity-50 has-data-checked:border-border-interactive has-data-checked:bg-surface has-[>[data-slot=field]]:rounded-none has-[>[data-slot=field]]:border *:data-[slot=field]:p-2 dark:has-data-checked:border-primary/20 dark:has-data-checked:bg-primary/10',
