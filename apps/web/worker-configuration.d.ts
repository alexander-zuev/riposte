/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env prod` (hash: 4cb82cfa720d0a0437359939b7ba2042)
// Runtime types generated with workerd@1.20260430.1 2026-04-21 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "RateLimiterDO" | "OutboxRelayDO";
	}
	interface Env {
		AUTH_KV: KVNamespace;
		...
		ENV: "production";
		APP_URL: "https://riposte.sh";
		SENTRY_DSN: "https://be15dbb0ce04a60ac3d39dc7ddb9fec2@o4508393623257088.ingest.us.sentry.io/4511314272583680";
		POSTHOG_API_KEY: "phc_nYQ6Wm37RsonpnciM4CkjVaFtgQwU3XBBducMjZTfA4K";
		GOOGLE_CLIENT_ID: "189119872614-dmtnkqeoibjubc0frpkms8sptbn9j2h0.apps.googleusercontent.com";
		GITHUB_CLIENT_ID: "Ov23litSGfhKN1kOckGN";
		...
		AUTH_RATE_LIMITER: DurableObjectNamespace<import("./src/server").RateLimiterDO>;
		OUTBOX_RELAY: DurableObjectNamespace<import("./src/server").OutboxRelayDO>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENV" | "APP_URL" | "SENTRY_DSN" | "POSTHOG_API_KEY" | "GOOGLE_CLIENT_ID" | "GITHUB_CLIENT_ID" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_SECRET" | "GITHUB_CLIENT_SECRET" | "TURNSTILE_SECRET_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET">> {}
}
declare module "*.sql" {
	const value: string;
